...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of cookies_filters"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of cookies_filters"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/cookies_filters_git_MajkiIT/'
